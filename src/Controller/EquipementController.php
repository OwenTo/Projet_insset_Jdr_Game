...
{
    /**
     * @Route("/liste/equipement", name="equipement_index", methods={"GET"})
     */
    ...
    /**
     * @Route("/create/equipement", name="equipement_new", methods={"GET","POST"})
     */
    ...
    /**
     * @Route("/detail/equipement/{id}", name="equipement_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/supression/{id}", name="equipement_delete", methods={"DELETE"})
     */
