...
class TypeArmeController extends AbstractController
{
    ...
    {
        return $this->render('type_arme/index.html.twig', ['type_armes' => $typeArmeRepository->findAll()]);
    }
    ...
    {
        return $this->render('type_arme/show.html.twig', ['type_arme' => $typeArme]);
    }
    ...
    public function edit(Request $request, TypeArme $typeArme): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('type_arme_index', ['id' => $typeArme->getId()]);
        }
