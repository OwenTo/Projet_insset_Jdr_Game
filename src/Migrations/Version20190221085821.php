 ...
 */
final class Version20190221085821 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE inventaire_arme (id INT AUTO_INCREMENT NOT NULL, type_arme_inventaire_id INT DEFAULT NULL, type_categorie_inventaire_id INT DEFAULT NULL, materiel_inventaire_id INT DEFAULT NULL, degat_arme_inventaire INT NOT NULL, INDEX IDX_D76C2EBC49719342 (type_arme_inventaire_id), INDEX IDX_D76C2EBC9BEEEF7C (type_categorie_inventaire_id), INDEX IDX_D76C2EBC1A7C3E96 (materiel_inventaire_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
